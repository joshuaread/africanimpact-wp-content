...
<?php wp_head(); ?>
<link rel='stylesheet' href='<?php echo get_stylesheet_directory_uri();?>/customstyle.css?counter=<?php echo time(); ?>' type='text/css' media='all' />
	...
	<header id="top">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="homelink" class="col span_3">
					
					<a id="logo" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>

						<?php /* nectar_logo_output($activate_transparency, $sideWidgetClass); */ ?>
						<img src="https://africanimpact.wpengine.com/wp-content/themes/salient/img/volunteer%20with%20african%20impact.svg" alt="Voluneer with African Impact" /> 
				...
				<div class="col span_9 col_last"> 
					<a id="specialApply" class="nectar-button small regular accent-color regular-button" style="visibility: visible;" href="#apply" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff"><span>APPLY NOW</span></a>
