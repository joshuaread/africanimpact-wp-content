								...
								<div class="wpb_wrapper">
									<div class="sticky-wrapper">
										<div class="page-submenu" data-bg-color="#434343" data-sticky="true" data-alignment="center" style="top: 172px;transform: translateY(0px);">
											...
											<div class="full-width-content" style="background-color: rgb(255, 255, 255); color: rgb(67, 67, 67); margin-left: -90px; width: 1280px; visibility: visible;height: auto!important; border-bottom:1px solid #e3e3e3;"><a href="#" class="mobile-menu-link"><i class="salient-page-submenu-icon"></i>Menu</a><ul style="background-color:#ffffff; color: #434343;"><li><a href="#overview">Overview</a></li><li><a href="#dates-rates">Dates &amp; Rates</a></li><li><a href="#destination">Destination</a></li><li><a href="#work-impacts">Work &amp; Impacts</a></li><li><a href="#fun-travel">Fun &amp; Travel</a></li><li><a href="#gallery">Gallery</a></li><li><a href="#more-info">More Info</a></li></ul>
											</div>
										</div>
									</div>
								</div> 
