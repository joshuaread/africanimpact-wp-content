							...
							<div class="vc_column-inner">
								<div class="wpb_wrapper">
									<div class="sticky-wrapper">
										<div class="page-submenu" data-bg-color="#434343" data-sticky="true" data-alignment="center" style="top: 172px;transform: translateY(0px);">
											<div class="full-width-content" style="background-color: #434343; color: rgb(255, 255, 255); margin-left: -90px; width: 1280px; visibility: visible;height: auto!important;">
												<div id="priceBox">
													<span class="from">FROM</span>
													<span class="pricing"><?php $key="pricing"; echo get_post_meta($post->ID, $key, true); ?></span>
													<? /* <a class="nectar-button small see-through-2 " style="visibility: visible; color: rgb(221, 221, 221); border-color: rgba(221, 221, 221, 0.75); background-color: transparent;" href="#" data-color-override="#dddddd" data-hover-color-override="false" data-hover-text-color-override="#ffffff"><span>APPLY NOW</span></a> */ ?>
													<a class="nectar-button small regular accent-color  regular-button" style="visibility: visible;" href="#apply" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff"><span>APPLY NOW</span></a>
												</div>
											</div>
											<div class="full-width-content" style="background-color: rgb(255, 255, 255); color: rgb(67, 67, 67); margin-left: -90px; width: 1280px; visibility: visible;height: auto!important; border-bottom:1px solid #e3e3e3;"><a href="#" class="mobile-menu-link"><i class="salient-page-submenu-icon"></i>Menu</a><ul style="background-color:#ffffff; color: #434343;"><li><a href="#overview">Overview</a></li><li><a href="#dates-rates">Dates &amp; Rates</a></li><li><a href="#destination">Destination</a></li><li><a href="#work-impacts">Work &amp; Impacts</a></li><li><a href="#fun-travel">Fun &amp; Travel</a></li><li><a href="#gallery">Gallery</a></li><li><a href="#blogs">Project Blogs</a></li><li><a href="#more-info">More Info</a></li></ul>
											</div>
										</div>
									</div>
								</div> 
